...
def generate_launch_description():
    return LaunchDescription([
        ...
        #Node(
          #package='rviz2',
          #executable='rviz2',
          #arguments=['-d','./src/chibi26_a/local_path_planner/launch/teamb_rviz2_debag.rviz'],  #<-ファイルのある場所を変える必要あり
          #parameters=[{'use_sim_time': True}],
        #),
        ...
        TimerAction(
            ...
            actions=[
                ...
                # ExecuteProcess(
                #    cmd=['ros2', 'bag', 'play', '/home/user/ws/src/bag/rosbag2_2026_03_11-07_12_07', '--clock'], #<-bagファイルの指定を変える必要あり
                # output='screen'
                # )
            ]
        ),
